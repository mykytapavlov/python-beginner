...
if __name__ == '__main__':
    ...
    if search_criteria == 'genre':
        ...
        while selected_genre not in available_genres:
        ...
        while selected_movie not in movies_by_genre:
        ...
        while selected_actor not in unique_actors_list:
        ...
        selected_movie = input('Please enter movie: ')
        while selected_movie not in res_movie_list:
            print(f'Movie {selected_movie} with {selected_actor} not found. Please try again.')
            selected_movie = input('Please enter movie: ')
